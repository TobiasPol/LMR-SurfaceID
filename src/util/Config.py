...
class Config:
    def __init__(self, path):
        ...
        self.RESTRICT = self.config.get("RESTRICT")
        ...
        self.nmin_pts_library = self.config.get("SPATIAL_PARAMETER").get(
            "nmin_pts_library"
        )
        ...
        self.contact_thres1 = self.config.get("SPATIAL_PARAMETER").get(
            "contact_thres1"
        )  # for identifying iface points
        self.contact_thres2 = self.config.get("SPATIAL_PARAMETER").get(
            "contact_thres2"
        )  # for distance based interacting points
        ...
        self.HIT_COLUMNS = self.config.get("HIT_COLUMNS")
